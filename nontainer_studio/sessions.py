...
STUDIO_PRIMER = (
    ...
    "render results inline in your reply. For static chart IMAGES use "
    "matplotlib (savefig works); plotly is for interactive figures — "
    "its write_image/kaleido path cannot run here. Every turn is a "
    "checkpoint "
